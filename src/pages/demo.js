...
import { 
  ShieldCheck, Users, BarChart3, QrCode, Mic, 
  Mail, Smartphone, Globe, Lock, ArrowRight,
  Music, Sparkles, Send, LayoutDashboard, Calendar, 
  CreditCard, Settings, Code2, Database, Palette, Cpu, Github, Linkedin, ExternalLink
} from 'lucide-react';
...
export default function FullDemoPage() {
  ...
  return (
    <div className="min-h-screen bg-[#02020a] text-white font-sans selection:bg-blue-500 selection:text-white">
      ...
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-black/80 backdrop-blur-md py-4 border-b border-white/10" : "bg-transparent py-8"}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-8 text-[10px] font-bold uppercase tracking-widest text-gray-400">
            ...
            <button onClick={() => scrollTo('studio')} className="hover:text-white transition-colors">Studio</button>
      ...
      {/* --- 1. HERO SECTION --- */}
      <header className="relative pt-48 pb-20 px-6 text-center overflow-hidden">
        ...
        <FadeInWhenVisible>
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto mb-16 italic leading-relaxed">
            Innovation condensées dans une interface d'exception. 
      ...
      <main className="max-w-7xl mx-auto px-6 space-y-48">
          ...
          <FadeInWhenVisible>
            <div className="grid lg:grid-cols-2 gap-20 items-center italic">
              ...
              <div className="space-y-8 italic">
                <h2 className="text-4xl font-black italic uppercase tracking-tighter italic">02. Pilotage & Statistiques</h2>
        ...
        <section id="studio">
          <FadeInWhenVisible>
            <div className="relative p-12 md:p-24 bg-gradient-to-br from-slate-900 to-[#02020a] rounded-[4rem] border border-white/5 overflow-hidden">
              <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center italic">
                <div className="space-y-6 italic">
                  <Mic size={50} className="text-red-500 animate-pulse" />
                  <h2 className="text-4xl font-black uppercase tracking-tighter italic italic">Studio Vocal Intégré</h2>
                  <p className="text-gray-400 italic">Capturez l'émotion pure avec Supabase Storage.</p>
                </div>
              </div>
            </div>
          </FadeInWhenVisible>
      ...
      {/* --- FOOTER IDENTITÉ PROFESSIONNELLE --- */}
          ...
          <div className="grid lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-5 space-y-8">
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h3 className="text-3xl font-black uppercase italic tracking-tighter italic italic">SHERIA GACHABA JASON</h3>
                  <p className="text-blue-500 font-bold text-xs uppercase tracking-widest italic italic italic">Ingénieur Logiciel & Design</p>
                </div>
              </div>
              <p className="text-gray-400 italic italic leading-relaxed">
                Spécialisé dans la conception d'écosystèmes numériques complexes. Alliant l'expertise en <span className="text-white font-bold italic italic italic italic">Architecture Logicielle</span>, <span className="text-white font-bold italic italic italic italic">Data Analysis</span> et <span className="text-white font-bold italic italic italic italic">UX Luxury Design</span>, je transforme des idées conceptuelles en produits robustes et scalables.
              </p>
            ...
            {/* Compétences (Data & Dev) */}
            <div className="lg:col-span-7 grid sm:grid-cols-2 gap-8 italic">
              <div className="space-y-6 italic italic">
                <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-gray-500 italic italic italic">Technical Expertise</h4>
                <div className="space-y-4 italic italic">
                  <div className="flex gap-4 italic italic italic"><Cpu className="text-blue-500" size={20}/> <div><p className="font-bold text-sm italic">Software Engineering</p><p className="text-xs text-gray-500 italic italic">React, Native, Node.js, Cloud</p></div></div>
                  <div className="flex gap-4 italic italic italic"><Database className="text-purple-500" size={20}/> <div><p className="font-bold text-sm italic italic">Data Analysis</p><p className="text-xs text-gray-500 italic italic italic">Architecture SQL, Supabase, BI</p></div></div>
                  <div className="flex gap-4 italic italic italic"><Palette className="text-emerald-500" size={20}/> <div><p className="font-bold text-sm italic italic italic italic">Product Design</p><p className="text-xs text-gray-500 italic italic italic italic italic italic">UI/UX, Prototypage, Motion</p></div></div>
                </div>
              </div>
              
              <div className="bg-white/5 border border-white/10 p-8 rounded-3xl italic italic italic">
                <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-gray-500 italic italic mb-4">Quick Stats</h4>
                <ul className="space-y-4 text-sm font-bold italic italic italic italic">
                  <li className="flex justify-between tracking-tighter italic italic italic italic italic uppercase italic"><span>Code Accuracy</span> <span className="text-blue-500 italic italic italic">99.9%</span></li>
                  <li className="flex justify-between tracking-tighter italic italic italic italic italic uppercase italic italic italic italic italic"><span>Experience</span> <span className="text-blue-500 italic italic italic italic italic italic">5+ Years</span></li>
                  <li className="flex justify-between tracking-tighter italic italic italic italic italic uppercase italic italic italic italic italic italic italic italic italic"><span>Projects Built</span> <span className="text-blue-500 italic italic italic italic italic italic italic italic italic italic italic">40+</span></li>
                </ul>
              </div>
            </div>
          </div>

          <div className="mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 italic italic italic">
            <p className="text-[10px] font-black tracking-[0.8em] uppercase text-gray-600 italic italic">Event Master Mega Luxury • 2026</p>
            <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-blue-500 italic italic italic">
